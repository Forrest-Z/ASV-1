...
figure(4);
subplot(321);
plot(estimator.timestamp,estimator.State(:,1),'linewidth', 2);
ylabel('x');
subplot(322);
plot(estimator.timestamp,estimator.State(:,2),'linewidth', 2);
ylabel('y');
subplot(323);
plot(estimator.timestamp,estimator.State(:,3),'linewidth', 2);
ylabel('theta');
subplot(324);
